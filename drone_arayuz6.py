...
class Ui_MainWindow(object):
    ...
    def gorev1(self):
        ...
        konum1 =  LocationGlobalRelative(40.9865192 ,29.0536673,10)       
        konum2 =  LocationGlobalRelative(40.9864704 ,29.0545685,10)
        konum3 =  LocationGlobalRelative(40.9867956 ,29.0552015,10)
        konum4 =  LocationGlobalRelative(40.9873078 ,29.0546222,10)
        konum5 =  LocationGlobalRelative(40.9873891 ,29.0538068,10)
        konum6 =  LocationGlobalRelative(40.9874785 ,29.0529270,10)
        konum7 =  LocationGlobalRelative(40.9871045 ,29.0523798,10)
        konum8 =  LocationGlobalRelative(40.9866899 ,29.0527768,10)
        time.sleep(0.5)
        ...
        while (1):
            u1 =self.uzaklik(vehicle.location.global_frame.lat,vehicle.location.global_frame.lon,40.9864704,29.0545685)
            if u1 <5 :
                break
            else :
                print("konum2 ye gidiliyor")
                durumstr = "konum2 ye gidiliyor"
                time.sleep(1)
        time.sleep(0.5)        
        vehicle.simple_goto(konum3)
        vehicle.simple_goto(konum3)
        vehicle.simple_goto(konum3)
        time.sleep(0.5)
        vehicle.simple_goto(konum3)
        while (1):
            u1 =self.uzaklik(vehicle.location.global_frame.lat,vehicle.location.global_frame.lon,40.9867956,29.0552015)
            if u1 <5 :
                break
            else :
                print("konum3 e gidiliyor")
                durumstr = "konum3 e gidiliyor"
                time.sleep(1)
        time.sleep(0.5)
        vehicle.simple_goto(konum4)
        vehicle.simple_goto(konum4)
        vehicle.simple_goto(konum4)
        time.sleep(0.5)
        vehicle.simple_goto(konum4)
        while (1):
            ...
            u1 =self.uzaklik(vehicle.location.global_frame.lat,vehicle.location.global_frame.lon,40.9873078,29.0546222)
            if u1 <5 :
                break
            
            else :
                print("konum4 e gidiliyor")
                durumstr = "konum4 e gidiliyor"
                time.sleep(1)
        ...
        while (1):
            ...
            u1 =self.uzaklik(vehicle.location.global_frame.lat,vehicle.location.global_frame.lon,40.9874785,29.0529270)
            if u1 <5 :
                break
            
            else :
                print("konum6 ya gidiliyor")
                durumstr = "konum6 ya gidiliyor"
                time.sleep(1)
        #vehicle.mode = VehicleMode("STABILIZE")
        #vehicle.mode = VehicleMode("GUIDED")
        time.sleep(1)
        vehicle.simple_goto(konum7) 
        vehicle.simple_goto(konum7) 
        vehicle.simple_goto(konum7) 
        time.sleep(0.5)
        vehicle.simple_goto(konum7) 
        while (1):
            ...
            u1 =self.uzaklik(vehicle.location.global_frame.lat,vehicle.location.global_frame.lon,40.9871045,29.0523798)
            if u1 <5 :
                break
            
            else :
                print("konum7 ye gidiliyor")
                durumstr = "konum7 ye gidiliyor"
                time.sleep(1)        
        time.sleep(0.5)
        vehicle.simple_goto(konum8)
        vehicle.simple_goto(konum8)
        vehicle.simple_goto(konum8)
        time.sleep(0.5) 
        vehicle.simple_goto(konum8)
        while (1):
            ...
            u1 =self.uzaklik(vehicle.location.global_frame.lat,vehicle.location.global_frame.lon,40.9866899 ,29.0527768)
            if u1 <5 :
                break
            
            else :
                print("konum8 e gidiliyor")
                durumstr = "konum8 e gidiliyor"
                time.sleep(1)        
        ...
        while (1):
            ...
            u1 =self.uzaklik(vehicle.location.global_frame.lat,vehicle.location.global_frame.lon,40.9865192,29.0536673)
            if u1 <5 :
                break
            
            else :
                print("konum1 e gidiliyor")
                durumstr = "konum1 e gidiliyor"
                time.sleep(1) 
        print("görev tamamlandı.")
        print("Bırakma noktası enlem :"+nokta_e)
        print("Bırakma noktası boylam :"+nokta_b)
